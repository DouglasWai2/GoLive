...
public class JavaAudioDeviceModule implements AudioDeviceModule {
  ...
  /**
   * Switches subsequent audio input to Android playback capture. The projection must be the same
   * instance used by the active screen capturer. Passing {@code null} restores microphone input.
   * The switch is rejected while an AudioRecord is active.
   */
  public boolean setAudioPlaybackCaptureMediaProjection(
      @Nullable MediaProjection mediaProjection) {
    return audioInput.setAudioPlaybackCaptureMediaProjection(mediaProjection);
  }
